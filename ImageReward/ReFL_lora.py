...
class Trainer(object):
    def __init__(self, pretrained_model_name_or_path, train_data_dir, args):
        ...
        self.reward_model = RM.load("checkpoint/ImageReward.pt", med_config="checkpoint/med_config.json", device=self.accelerator.device)
    ...
    def train(self, args):
        ...
        for epoch in range(first_epoch, args.num_train_epochs):
            ...
            for step, batch in enumerate(self.train_dataloader):
                ...
                with self.accelerator.accumulate(self.unet):
                    ...
                    # Use self.noise_scheduler to predict the original latent (pred_original_sample).
                    # Read reference/*.py for help.
                    # ==========Todo Begin==========
        ...
        if self.accelerator.is_main_process:
            ...
            self.unet.save_attn_procs(args.output_dir)
            if args.push_to_hub:
                upload_folder(
